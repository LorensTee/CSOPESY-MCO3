...
| **P1** | Step 6: T3.4 Windows gate, T5.1–T5.3, T1.4/T3.3 measurements, T2.6 `README.txt` | **A1–A11 on the Windows build ✅ T5.1 done 2026-09-24** (`docs/t5.1-windows-acceptance.md`); **T5.2** macOS (W4) + Windows (T5.1) evidenced, Linux (W1) still open; measurement tables committed (blocked on `T6.3`) |
